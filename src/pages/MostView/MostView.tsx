...
import "./MostView.styles.scss";
import { IFilterBook } from "../../common/book.interface";
import CBookCard from "../../components/BookCard/CBookCard";
import { Variants, motion } from "framer-motion";
import { advancedSearchingRequest, getBookBestSellerRequest, getBookMostViewRequest, getFileBookRequests } from "../../redux/controller";
...
const MostView = () => {
    ...
    const {
        listBookMostView , totalBookMostView
    ...
    const onChangePage = (event: any) => {
        ...
        dispatch(getBookMostViewRequest(currentSearchValue))
        document.body.scrollTo({
            top: 0,
            behavior: "smooth"
        });
