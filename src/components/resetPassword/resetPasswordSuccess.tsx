...
import './resetPasswordSuccess.styles.scss'
import { useDispatchRoot, useSelectorRoot } from "../../redux/store";
import { forgotPasswordRequest, registerRequest, resetPasswordRequest } from "../../redux/controller";
...
const ResetPasswordSuccess = () => {
    ...
    const onFinish = () => {
        ...
        dispatch(resetPasswordRequest(bodyRequest))
        setTimeout(()=>{
            navigate("/")
        },2000)
